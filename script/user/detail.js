  ...
  try {
    ...
    trainingItem.innerHTML = `
      ...
      <div class="card-body">
        ...
        <h4 class="card-subtitle mb-2 fw-light text-center">${
          training.penyelenggara
        }</h4>
        <p class="card-text"><strong>Durasi:</strong> ${
          training.durasi
        } Minggu</p>
        <p class="card-text"><strong>Kelompok Umur:</strong> ${
          training.kelompok_umur
        } Tahun</p>
        ...
        <h5>Persyaratan:</h5>
        <ul>${training.persyaratan
          .map((item) => `<li>${item}</li>`)
          .join("")}</ul>
        <h5>Fasilitas:</h5>
        <ul>${training.fasilitas
          .map((item) => `<li>${item}</li>`)
          .join("")}</ul>
        <p class="card-text"><strong>Pendaftaran:</strong> ${
          training.pendaftaran
        }</p>
        <p class="card-text"><strong>Kontak:</strong></p>
        <ul>${training.kontak.map((item) => `<li>${item}</li>`).join("")}</ul>
        <p class="card-text"><strong>Link Pendaftaran:</strong> <a href="${
          training.link_pendaftaran
        }" target="_blank">${training.link_pendaftaran}</a></p>
        <p class="card-text"><strong>Sumber Informasi:</strong> <a href="${
          training.sumber_informasi
        }" target="_blank">${training.sumber_informasi}</a></p>
      </div>
    `;
